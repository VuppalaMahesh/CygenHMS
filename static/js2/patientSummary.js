...
for (var i = 0; i < data.length; i++) {
    ...
    medications_view += '<ul>';
    var medicinName= alr.medicinname;
//    alert(medicinName)
    var result=medicinName.split(':');
    medications_view += '<li style="font-size:13px"><span style="color:#222222;">Medicine name:</span><span>' +medicinName + '</span></li>';
    medications_view += '<li style="font-size:13px"><span style="color:#222222;">Composition Name:</span><span>' + alr.compositionName + '</span></li>';
    medications_view += '<li style="font-size:13px"><span style="color:#222222;">Usage Directions:</span><span>' + alr.usageDirection + '</span></li>';
    medications_view += '</ul>';
    ...
    medications_view += '<li style="font-size:13px"><span style="color:#222222;">Created on:</span><span>' + alr.created_date + '</span></li>';
    medications_view += '</ul>';
    medications_view += '</div>';
    medications_view += '<div style="float: left; width: 33%;padding: 10px;height: auto;">';
    medications_view += '<ul>';
    medications_view += '<li style="font-size:13px"><span style="color:#222222;">Frequency:</span><span>' + alr.frequency + '/'+alr.withfood+'</span></li>';
    medications_view += '<li style="font-size:13px"><span style="color:#222222;">Duration:</span><span>' + alr.duration + '</span></li>';
...
var opdPatientUHID = "";
            ...
            opdPatientUHID += '<tbody style="border:5px">';
            opdPatientUHID += '<tr>';
            opdPatientUHID += '<td style="font-size:13px"><span style="color:#222222; font-size: 15px";>UHID : </span><span>' +data.UHID+ '</span></td>';
            opdPatientUHID += '</tr>';
            console.log("Himavanth PAtient details");
            opdPatientUHID += '</tbody>';

$("#opdPatientUHID").html(opdPatientUHID)
