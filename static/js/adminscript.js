...
//                    patient_view += '<td ><a style="color: #64c1b1; " href="javascript:void(0)" data-id= "' + alr.UHID + '" class="patientLinkappoint fa fa-id-badge fa-lg"></a></td>';
                    ...
                    patient_view += '<td ><a style="color: #64c1b1; " href="/bills/'+alr.appointment+'" class=" fa fa-clipboard fa-lg" ></a></td>';                    
                ...
                $("#patienttableInReceptionist").html(patient_view);
            }
            else{
          $('#patient_show').hide();
          $("#nodata").show();
    ...
    get_doctor_data(function (data, status) {
        ...
        if (data.length >= 0) {
            for (var i = 0; i < data.length; i++) {
                ...
                doctor_view += '<td><a style="color: #64c1b1; " href="/doctoravailabilitystatus/'+alr.doc.id+'/"  class="fa fa-address-card-o "></a> </td>';
...
//                patient_view += '<td ><a style="color: #64c1b1; " href="/summary/'+String(alr.pat.id)+'/"class="fa fa-folder-open fa-lg" ></a></td>';
...
$(function () {
    get_alternatecontact_data(function (data, status) {
        ...
        patientpersonal_view += '<td ><div><div>NAME </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.pat.first_name + " " + data.pat.middle_name + " " + data.pat.last_name + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td ><div><div>UHID </div><div style="font-size:17px !important;color:black !important;">' + data.UHID + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td ><div><div>GENDER </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.pat.gender + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td ><div><div>AGE</div><div style="font-size:17px !important;;color:black !important;text-transform:capitalize">' + data.age + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td ><div><div>OCCUPATION </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.occupation + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        ...
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>MARITAL STATUS </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.maritial_status + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>ETHNICITY </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.ethnicity + '</div> </div></td>';
        // patientpersonal_view += '<td><hr></td>';
...
$(function () {
    get_alternatecontact_data(function (data, status) {
        ...
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>ADDRESS </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.address + ", " + data.address2 + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>CITY </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.city + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>STATE </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.state + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>COUNTRY </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.country + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
...
$(function () {
    get_alternatecontact_data(function (data, status) {
        ...
        patientpersonal_view += '<td><div><div>EMERGENCY CONTACT NAME </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.emergencycontactfname + " " + data.emergencycontactlname + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
        patientpersonal_view += '<td><div><div>RELATIONSHIP </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.emergencyrelationship + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
...
$(function () {
    get_alternatecontact_data(function (data, status) {
        ...
        patientpersonal_view += '<td><div><div>FAMILY DOCTOR NAME </div><div style="font-size:17px !important;color:black !important;text-transform:capitalize">' + data.familyDoctorName + '</div></div></td>';
        patientpersonal_view += '<td><hr></td>';
