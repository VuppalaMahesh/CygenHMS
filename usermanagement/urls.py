...
urlpatterns = [
    ...
    url(r'^patients/$', views.patient_listehr_physian_view, name='createphysianehr'),
    ...
    url(r'^getappointedpatients/$', views.appointedpatients.as_view(), name='getpatient'),
    ...
    url(r'^searchpatient/$', views.searchpatdata.as_view(), name='search patient'),
    ...
    url(r'^medicationdetails/(?P<pat_id>[0-9]+)/$', views.medicationdetails, name='medicationdetails'),
    url(r'^vaccinedetails/(?P<pat_id>[0-9]+)/$', views.vaccinedetails, name='vaccinedetails'),
    url(r'^testdetails/(?P<pat_id>[0-9]+)/$', views.testdetails, name='testdetails'),

    url(r'^doctoravailabilitystatus/(?P<id>[0-9]+)/$',views.Doctoravailability, name="doctoravailabilityform"),
    url(r'^ehr/(?P<pat_id>[0-9]+)/$', views.totalhealthrecordphysicanview, name='healthrecordphsican'),
    url(r'^inpatients/$', views.appointedInpatients.as_view(), name='getInpatient')
]