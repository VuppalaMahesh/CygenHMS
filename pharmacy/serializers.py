...
class Multipleappointmentserializer(ModelSerializer):
    ...
    UHID = serializers.CharField(source='patient')
    ...
    class Meta:
        model = Appointment
        fields = ("appointmentId",'appointmentDate','UHID')
...
class GetMedicationsserializer(ModelSerializer):
    ...
    def get_patient(self, obj):
        # print(obj.patient.pat.first_name)
        return '{} {} {}'.format(obj.patient.pat.first_name, obj.patient.pat.middle_name, obj.patient.pat.middle_name)
    class Meta:
        model = Appointment
        fields = ['appointmentId','medications', 'doctor','patient']
